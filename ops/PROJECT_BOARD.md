...
- 실제 활성 검수 작업: OPS-042 검수본 GitHub 별도 브랜치·draft PR 보존 (`IN_PROGRESS`)
...
- 현재 활성 작업: OPS-042 (격리 snapshot 조립·검증)
...
| --- | --- | --- | --- | --- | --- |
| OPS-042 | 고객형 업체 7곳 검수본 GitHub 별도 브랜치 보존 | 총괄 PM·품질 | IN_PROGRESS | P0 | 별도 브랜치 조립·검사·draft PR 생성 |
